  ...
  return (
    <>
      ...
      {otherPausedJobs.length > 0 && (
        <motion.button
          initial={scaleInOut.hidden}
          animate={scaleInOut.visible}
          exit={scaleInOut.exit}
      ...
      <AnimatePresence>
        {isOpen && (
          <>
            ...
            {/* Drawer Panel */}
            <motion.div
              initial={slideUpDrawer.hidden}
              animate={slideUpDrawer.visible}
              exit={slideUpDrawer.exit}
