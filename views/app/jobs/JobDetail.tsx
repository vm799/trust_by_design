        ...
        <div className="space-y-6">
          ...
          {!magicLink ? (
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <a
                  href={`https://wa.me/${technician?.phone?.replace(/\D/g, '') || ''}?text=${encodeURIComponent(`Hi ${technician?.name || ''},\n\nYou have a new job assignment:\n${job?.title || 'Job'}\n\nClick here to access it:\n${magicLink}`)}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="py-3 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl font-bold text-sm uppercase tracking-wider transition-all active:scale-[0.98] flex items-center justify-center gap-2"
                >
                ...
                <a
                  href={`sms:${technician?.phone || ''}?body=${encodeURIComponent(`New job: ${job?.title || 'Job'} - ${magicLink}`)}`}
                  className="py-3 bg-blue-600 hover:bg-blue-500 text-white rounded-xl font-bold text-sm uppercase tracking-wider transition-all active:scale-[0.98] flex items-center justify-center gap-2"
                >
