...
const TemplatesView: React.FC<TemplatesViewProps> = ({ user }) => {
  ...
  const templates = [
    ...
    { id: 't2', name: 'Mechanical Systems Check', description: 'Quarterly operational protocol for HVAC/R units.', tasks: 12 },
    { id: 't3', name: 'Rapid Proof Capture', description: 'Priority evidence sequence for emergency callouts.', tasks: 4 },
  ];
